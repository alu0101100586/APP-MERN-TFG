    ...
    <div className="home-page">
      ...
      <div className="home-page__artist">
        ...
        <p>
          ...
          de una forma sencilla y rápida. Tenemos una facilidad para dar a
          conocer tu trabajo y que los usuarios puedan apoyarte. ¡Registrate en
          CrowdSound!
        </p>
        <Button size="large" primary onClick={handleButtonClick}>
      ...
      <div className="home-page__contact">
        ...
        <p>
          ...
          con nosotros a través de nuestras redes sociales. ¡Te responderemos lo
          antes posible!
        </p>
