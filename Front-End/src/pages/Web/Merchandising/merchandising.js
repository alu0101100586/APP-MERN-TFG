...
export function Merchandising() {
  ...
  if (merch.size.length >= 2) {
    ...
    size = merch.size.slice(0, merch.size.length - 1).join(', ') + ' y ' + lastSize;
  } else {
        ...
        <Grid.Column>
          <div className='merch-info'>
            ...
            <p>
              ...
              <span style={{ fontWeight: "bold" }}> {merch.price}€</span>
              {' '}hasta el dia {' '}
              <span style={{ fontWeight: "bold" }}>{formatDate(merch.releaseDate)}</span>.
        ...
        <Grid.Column>
          <div className='crowdfunding-info'>
            ...
            <p>
              ...
              <span style={{ fontWeight: "bold" }}>{merch.raisedMoney}€</span> de
              a falta de {' '}
              <span style={{ fontWeight: "bold" }}>{merch.moneyLimit - merch.raisedMoney}€</span>
